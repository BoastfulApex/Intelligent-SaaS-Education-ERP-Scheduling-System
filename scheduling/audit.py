...
def connect_all():
    ...
    from .models import (
        ...
        Schedule, ScheduleEntry, Substitution, LoadSheet, SubjectTeacher,
    )
    ...
    register_audit(SubjectTeacher, org_path='curriculum_subject.block.curriculum.major.organization')
